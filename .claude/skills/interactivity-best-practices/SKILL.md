...
description: >
  Best practices for writing Remotion animations that stay intuitive for coding agents and
  remain editable in Remotion Studio Visual Mode — keeping values literal and inline where the
  Studio can find them, rather than hidden behind indirection. Use when writing or refactoring
  a Remotion composition, or when an animation is correct in code but not editable in the
  Studio. Triggers - Remotion Studio, Visual Mode, editable animation, interpolate, spring,
  composition props.
---
