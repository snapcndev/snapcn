...
description: >
  Emil Kowalski's design-engineering philosophy on UI polish, component design, and the
  invisible details that make software feel great. Use when deciding whether an interaction
  needs motion, choosing duration and easing, designing a component's states (hover, focus,
  loading, empty, error), or judging why an interface feels cheap when nothing is technically
  wrong. Triggers - "make this feel better", "is this animation good", "design polish",
  "micro-interaction", "easing", "duration", "component states", "attention to detail".
---
