 ...
 * origin root by Next in the Player, but Remotion Studio and a render serve `public/` through
 * `staticFile()` alone — so rewrite local paths everywhere but the Player, and
